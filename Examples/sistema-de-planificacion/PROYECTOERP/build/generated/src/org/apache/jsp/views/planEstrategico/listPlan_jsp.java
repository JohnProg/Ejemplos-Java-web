...
ArrayList<PlanEstrategicoBean>          plans=null;
      ...
      out.write("            document.form.accion.value=\"CREATE\";\n");
      out.write("            document.form.submit();\n");
      out.write("        }\n");
      out.write("        function actualizar() {\n");
      out.write("            document.form.action = \"");
      out.print(request.getContextPath());
      out.write("/updatePlanServlet\";\n");
      out.write("            document.form.method = \"GET\";\n");
      out.write("            document.form.accion.value=\"UPDATE\";\n");
      out.write("            document.form.submit();\n");
      out.write("        }\n");
      out.write("        function eliminar() {\n");
      out.write("            document.form.action = \"");
      out.print(request.getContextPath());
      out.write("/deletePlanServlet\";\n");
      out.write("            document.form.method = \"GET\";\n");
      out.write("            document.form.accion.value=\"DELETE\";\n");
      out.write("            document.form.submit();\n");
      out.write("        }\n");
      out.write("    </script>\n");
      ...
      out.write("\t\t\t<br>\n");
      out.write("\t\t\t<br>\n");
      out.write("                        <h1>Planes estratégicos: <a href=\"\" onclick='javascript:crear()'class=\"pull-right btn btn-primary btn-lg\">+ Crear</a></h1>\n");
      out.write("\t\t\t<hr>\n");
      out.write("\t\t</header>\t\t\n");
      out.write("\t\t<br>\n");
      ...
      out.write("</td>\n");
      out.write("                                                               <td><a onclick=\"actualizar()\">Actualizar</a>\n");
      out.write("                                                                   <a onclick=\"eliminar()\">Eliminar</a>\n");
      out.write("                                                                   <a href=\"/lineas/\">Lineas</a></td>\n");
      out.write("                                                           </tr>\n");
      out.write("                                                          ");
   }
                                                          }

		...
		<section class="row">
			...
			<form class="col-sm-12" method="post" action="<%=request.getContextPath()%>/ObjetivoServlet">
					...
					<div class="row">
						...
						<div class="col-sm-2">
							<a href="<%=request.getContextPath()%>/ObjetivoServlet?option=1&id_linea=<%=request.getAttribute("id_linea") %>&id_plan=<%=request.getAttribute("id_plan") %>" class="btn btn-block btn-lg btn-danger">Cancelar</a>
						</div>
					</div>
				</fieldset>
			</form>

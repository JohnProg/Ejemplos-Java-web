			...
			<form class="col-sm-12">
				...
				<fieldset class="form-group">
					...
					<div class="row">
						...
						<div class="col-sm-2">
							<a href="<%=request.getContextPath()%>/SubObjetivoServlet?option=1&id_objetivo=<%=request.getAttribute("id_objetivo") %>" class="btn btn-block btn-lg btn-danger">Cancelar</a>
						</div>
					</div>
				</fieldset>				
			</form>

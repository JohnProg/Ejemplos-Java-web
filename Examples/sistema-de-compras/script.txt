...
insert into usuario(usuario, contrasena, id_fk_role, nombre) values ("johnp", "123", 2, "John Paul");
insert into usuario(usuario, contrasena, id_fk_role, nombre) values ("fiio", "root", 1, "Fiorella Silva");
insert into usuario(usuario, contrasena, id_fk_role, nombre) values ("rosita", "admin", 2, "Rosa Jimenez");
